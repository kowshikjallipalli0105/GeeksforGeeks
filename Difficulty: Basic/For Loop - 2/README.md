<h2><a href="https://www.geeksforgeeks.org/problems/for-loop-2/1?page=3&difficulty=Basic&status=unsolved&sortBy=submissions">For Loop - 2</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given a <strong>String S</strong>, you need to print its characters at even indices(index starts at 0). </span></p>
